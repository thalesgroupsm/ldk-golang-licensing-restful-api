...
func (a *LicenseApiService) GetFeatureInfo(ctx context.Context, localVarOptionals *QueryInfoOpts) (Features, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/features"
	localVarPath = strings.Replace(localVarPath, "{"+"vendorId"+"}", fmt.Sprintf("%v", a.client.cfg.VendorId), -1)
...
func (a *LicenseApiService) GetKeyInfo(ctx context.Context, localVarOptionals *QueryInfoOpts) (Keys, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"vendorId"+"}", fmt.Sprintf("%v", a.client.cfg.VendorId), -1)
...
func (a *LicenseApiService) GetProductInfo(ctx context.Context, localVarOptionals *QueryInfoOpts) (Products, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/products"
	localVarPath = strings.Replace(localVarPath, "{"+"vendorId"+"}", fmt.Sprintf("%v", a.client.cfg.VendorId), -1)
...
func (a *LicenseApiService) Login(ctx context.Context, licenseRequest LicenseRequest) (LicenseResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/sessions"
	localVarPath = strings.Replace(localVarPath, "{"+"vendorId"+"}", fmt.Sprintf("%v", a.client.cfg.VendorId), -1)
...
/*
LicenseApiService logout
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sessionId sessionId
 * @param vendorId vendorId
*/

func (a *LicenseApiService) Logout(ctx context.Context, sessionId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/sessions/{sessionId}"
...
func (a *LicenseApiService) Refresh(ctx context.Context, sessionId string) (LicenseResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/sessions/{sessionId}/refresh"
	localVarPath = strings.Replace(localVarPath, "{"+"sessionId"+"}", fmt.Sprintf("%v", sessionId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"vendorId"+"}", fmt.Sprintf("%v", a.client.cfg.VendorId), -1)
...
@return LicenseResponse
*/
func (a *LicenseApiService) Read(ctx context.Context, sessionId string, readInfo ReadInfo) (MemoryInfo, *http.Response, error) {
	var (
		localVarHttpMethod    = strings.ToUpper("GET")
		localVarFileName      string
		localVarFileBytes     []byte
		localVarMemoryContent MemoryInfo
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vendors/{vendorId}/sessions/{sessionId}/read"
	localVarPath = strings.Replace(localVarPath, "{"+"sessionId"+"}", fmt.Sprintf("%v", sessionId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"vendorId"+"}", fmt.Sprintf("%v", a.client.cfg.VendorId), -1)
	...
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, nil, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarMemoryContent, nil, err
	}

	localVarHttpResponse, err := a.client.callAPI(r)
	if err != nil || localVarHttpResponse == nil {
		return localVarMemoryContent, localVarHttpResponse, err
	}
	...
	if localVarHttpResponse.StatusCode < 300 {
		// If we succeed, return the data, otherwise pass on to decode error.
		err = a.client.decode(&localVarMemoryContent, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
		return localVarMemoryContent, localVarHttpResponse, err
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 401 || localVarHttpResponse.StatusCode == 403 || localVarHttpResponse.StatusCode == 422 {
			var v ErrorInfo
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarMemoryContent, localVarHttpResponse, newErr
			}
			newErr.model = v
			return localVarMemoryContent, localVarHttpResponse, newErr
		}
	...
	return localVarMemoryContent, localVarHttpResponse, nil
}
